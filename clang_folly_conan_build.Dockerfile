...
FROM clang_folly_conan_repoadd_source_install as clang_folly_conan_build_package_export_test_upload

ARG BUILD_TYPE=Release
ARG APT="apt-get -qq --no-install-recommends"
ARG LS_VERBOSE="ls -artl"
ARG CONAN="conan"
ARG PKG_NAME="clang_folly_conan/v2019.01.14.00"
ARG PKG_CHANNEL="conan/stable"
ARG PKG_UPLOAD_NAME="clang_folly_conan/v2019.01.14.00@conan/stable"
